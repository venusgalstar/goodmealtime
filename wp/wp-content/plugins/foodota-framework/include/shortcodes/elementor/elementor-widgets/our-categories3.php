...
class Ourcategories3 extends Widget_Base
{
    public function get_name()
    {
        return 'food-item-categories3';
    }

    public function get_title()
    {
        return __('Foodota-item-Categories3', 'foodota-framework');
    }
    ...
    protected function render()
    {
        ...
        if (\Elementor\Plugin::$instance->editor->is_edit_mode()) {
            ...
            <script>
                ...
                jQuery('.prop-types-carsol2').owlCarousel({
                    dots: false,
                    loop: true,
                    margin: 30,
                    nav: true,
    ...
    public function foodota_category2_slider($params)
    {
        ...
        return '<section class="res-cat cat-new-design section-padding ' . $foodota_text_color . '">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-xxl-12 col-xl-12 col-lg-12">
                    <div class="prop-types-carsol2 owl-carousel owl-theme">
                    ' . $res_html . '
                    </div>
                  </div>
                </div>
