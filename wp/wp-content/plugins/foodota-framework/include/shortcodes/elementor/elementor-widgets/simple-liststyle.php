...
class Simplelist extends Widget_Base
{
    public function get_name()
    {
        return 'simple-list-restaurants';
    }

    public function get_title()
    {
        return __('Simple-List-Restaurants', 'foodota-framework');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'food-list-grid',
            [
                'label' => __('Foodota simple list Restaurants', 'foodota-framework'),
    ...
    public function simple_grid_restaurants($params)
    {
        ...
        if ($view_btn_title != '' && $view_btn_link != '') {
            $button_classic = foodota_elementor_button_link($target_one, $nofollow_one, $view_btn_title, $view_btn_link, '');
        }
        ...
        if (is_array($query)) {
            foreach ($query as $agent_data) {
                $res_html .= ' <div class="col-xxl-6 col-xl-6 col-lg-12">' . foodota_all_restaurant_function($agent_data->ID, 'list-view') . '</div>';
            }
        }
        if ($header_design != '') {
        ...
        return '<section class="res-featured bg-color section-padding list-view ' . $foodota_text_color . '">
                  <div class="container">
                    <div class="row">
