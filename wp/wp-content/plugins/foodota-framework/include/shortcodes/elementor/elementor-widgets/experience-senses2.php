...
class Experiencesences2 extends Widget_Base
{

    public function get_name()
    {
        return 'foodota-experience2';
    }

    public function get_title()
    {
        return __('Restaurant-Experience2', 'foodota-framework');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'sub-title',
            [
                'label' => __('Sub Title For Main Heading', 'foodota-framework'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('tasty Burger', 'foodota-framework'),
                'placeholder' => __('Type Your Sub Title Heree!', 'foodota-framework'),
            ]
        );
        ...
        $this->add_control(
            'bike-bg',
            [
                'label' => __('Background image', 'foodota-framework'),
    ...
    protected function render()
    {
        ...
        $params['sub-title'] = $settings['sub-title'] ? $settings['sub-title'] : '';
    ...
    public function foodota_experience($params)
    {
        ...
        if ($search_now_title != '' && $search_now_link != '') {
            $button_search_now = foodota_elementor_button_link($target_two, $nofollow_two, $search_now_title, $search_now_link, 'btn btn-theme btn-select');
        }

        return '<div class="s-call-action ' . $foodota_text_color . '" style="background-image: url(' . $bike_url . '); -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-lg-12 col-md-12 col-xl-6">
                    <div class="s-call-action-content">
                        <div class="sub-title">' . $sup_title . '</div>
