...
class Howitwork2 extends Widget_Base
{
    public function get_name()
    {
        return 'foodota-how-work2';
    }

    public function get_title()
    {
        return __('Foodota-how-work2', 'foodota-framework');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('How It Work', 'foodota-framework'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Cash Delivery / Onlice Transfer', 'foodota-framework'),
                'placeholder' => __('Type your Restaurants Title Here!', 'foodota-framework'),
            ]
        );
        $this->add_control(
    ...
    public function how_it_works($params)
    {
        ...
        return '<section class="how-it-work2 bg-color cols-padding ' . $foodota_text_color . '">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 row-col-3 margin-bottom-30">
        ...
        <img src="' . esc_url($work_imag_1) . '" alt="' . esc_attr__('slider-image', 'foodota-framework') . '" class="img-fluid">
        </div>
        <div class="text-box">
            <h3>' . $work_title_1 . '</h3>
            <p>' . $work_des_1 . '</p>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 row-col-3 margin-bottom-30">
		 <div class="main-works-box">
         <div class="works-image-box">
        <img src="' . esc_url($work_imag_2) . '" alt="' . esc_attr__('slider-image', 'foodota-framework') . '" class="img-fluid">
        </div>
        <div class="text-box">
            <h3>' . $work_title_2 . '</h3>
            <p>' . $work_des_2 . '</p>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 row-col-3 margin-bottom-30">
		 <div class="main-works-box">
         <div class="works-image-box">
        <img src="' . esc_url($work_imag_3) . '" alt="' . esc_attr__('slider-image', 'foodota-framework') . '" class="img-fluid">
        </div>
        <div class="text-box">
            <h3>' . $work_title_3 . '</h3>
            <p>' . $work_des_3 . '</p>
